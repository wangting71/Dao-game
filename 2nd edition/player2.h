...
Move Player2::get_move(unsigned short player, board game_board)
{
    Move move;
    ...
    */
    ...
    else if (win_line)
    {
        ...
        else
        {
            ...
            if (abs(w_X - to_X) + abs(w_Y - to_Y) == 3)
            {
                for (int i = 0; i < XYDIM; i++)
                    for (int j = 0; j < XYDIM; j++)
                    {
...
bool Player2::moveable(unsigned short from_X, unsigned short  from_Y, unsigned short to_X, unsigned short to_Y, board game_board, unsigned short player)
{
    bool mov = true;
    unsigned short me, op;
    if (player == 1)
...
bool Player2::find_mid(unsigned short from_X, unsigned short  from_Y, unsigned short to_X, unsigned short to_Y, board game_board, unsigned short player, unsigned short& mid_X, unsigned short& mid_Y)
{
    bool find = false;
    int x = -1, y = -1;
